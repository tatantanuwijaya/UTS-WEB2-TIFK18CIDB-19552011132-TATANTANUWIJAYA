...
<body>
  ...
  <div class="page-section">
      <div class="container">
          <h1 class="text-center wow fadeInUp">Kontak Kami</h1>

          <form class="contact-form mt-5">
              <div class="row mb-3">
                  <div class="col-sm-6 py-2 wow fadeInUp">
                      <label for="fullName">Nama Lengkap</label>
                      <input type="text" id="fullName" class="form-control" placeholder="Masukkan nama lengkap"></input>
                  </div>
                  <div class="col-sm-6 py-2 wow fadeInUp">
                      <label for="emailAddress">Alamat Email</label>
                      <input type="text" id="emailAddress" class="form-control" placeholder="Masukkan alamat email"></input>
                  </div>
                  <div class="col-sm-12 py-2 wow fadeInUp">
                      <label for="fullName">Subjek</label>
                      <input type="text" id="subject" class="form-control" placeholder="Masukan subjek (Tentang apa)"></input>
                  </div>
                  <div class="col-12 py-2 wow fadeInUp">
                      <label for="fullName">Pesan</label>
                      <textarea id="message" class="form-control" rows="8" placeholder="Masukkan pesan yang ingin disampaikan"></textarea>
                  </div>
              </div>
              <button type="submit" class="btn btn-primary wow zoomIn">Kirim</button>
          </form>
      </div>
  </div>
