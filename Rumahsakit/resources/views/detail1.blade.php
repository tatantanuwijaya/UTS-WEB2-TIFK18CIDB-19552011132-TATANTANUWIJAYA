...
<head>
  ...
  <title>Artikel-Kasus corona naik, begini datanya pada bulan november lalu</title>
              ...
              <div class="col-lg-8">
                  <nav aria-label="Breadcrumb">
                      <ol class="breadcrumb bg-transparent py-0 mb-5">
                          ...
                          <li class="breadcrumb-item" aria-current="page"><a href="">Kasus aktif naik, begini data lengkap Kasus Corona di RI 25 November</a></li>
                      </ol>
                  </nav>
              </div>
          </div>
          ...
          <div class="row">
              <div class="col-lg-8">
                  <article class="blog-details">
                      <h1>Kasus aktif naik, begini data lengkap Kasus Corona di RI 25 November</h1>
                      <div class="post-thum">
                              ...
                              public function detail1(){
                                return array(
                                  '<p class="text-justify">
                                      Kasus positif Corona (COVID-19) di Indonesia bertambah 372 pada 25 
                                      November 2021. Sementara pasien yang dinyatakan sembuh mencapai 293 
                                      orang dan pasien yang meninggal dunia bertambah menjadi 16 orang.
                                  </p>',
                                  '<p class="text-justify">
                                      Dengan adanya data tersebut, maka total kasus positif COVID-19 di 
                                      Indonesia sejumlah 4.254.815 kasus. Kasus yang sembuh dari 
                                      COVID-19 sebanyak 4.102.993 kasus, dan untuk kasus yang 
                                      meninggal sebanyak 143.782 kasus.
                                  </p>',
                                  '<p class="text-justify">
                                      Berdasarkan data yang ada saat ini, kasus aktif Corona di 
                                      Indonesia meningkat 63 kasus pada hari itu. Dengan total 
                                      8.040 kasus aktif. Kasus aktif merupakan pasien corona yang 
                                      belum dapat dinyatakan sembuh maupun meninggal.
                                  </p>',
                                  '<p class="text-justify">
                                      Dari data sebaran yang didapatkan dari daerah, kasus yang 
                                      paling banyak pada 25 November 2021 terdapat di provinsi 
                                      DI Yogyakarta dengan jumlah kasus mencapai kasus, selanjutnya 
                                      DKI Jakarta dengan 54 kasus dan Jawa Tengah dengan 45 kasus.
                                  </p>',
                                  '<p class="text-justify">
                                      Sementara itu, ada 7 daerah yang melaporkan nihil kasus 
                                      corona pada hari itu. Daerah tersebut adalah Jambi, 
                                      Sumatera Selatan, Sulawesi Utara, Gorontalo, Sulawesi 
              ...
              <div class="col-lg-4">
                  <div class="sidebar-block">
                      ...
                      <div class="blog-item">
                          ...
                          <div class="content">
                            <h6><a href="{{url('detail2')}}">Varian Baru Botswanan B.1.1.529 dan Potensi bahayanya</a></h6>
                            <div class="meta">
